...
\]
both $A(X)$ and $B$ being absolutely convergent. Hence $c(X)\to c_0$ with
$c_0\in[1.02,1.05]$ and
\[
  \boxed{\ \beta_2(X)=1-\frac{c_0+o(1)}{\langle R_2/R_1\rangle_X}\ \longrightarrow\ 1,\qquad
  1-\beta_2(X)\asymp\frac{1}{\log\log X}.\ }
\]
\end{theorem}
...
$c(X)=A/B=1.045,1.032,1.025$ matches the measured
$(1-\beta_2)\langle R_2/R_1\rangle\approx1.09$ to within a few percent (the gap being
the linearisation remainder and HL error, both $o(1)$). In the Cram\'er model, where
