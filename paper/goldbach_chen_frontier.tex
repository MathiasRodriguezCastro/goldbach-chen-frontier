...
\begin{conjecture}[Slow singular drift]
The local singular exponent of $R_2$ satisfies $\beta_2(X)\to\infty$, growing like
$c\log\log X$ for some $c\in(0,\tfrac14]$; in particular $R_2/R_1$ has no fixed
singular-series power, and the apparent half-power is a finite-range artefact.
\end{conjecture}
